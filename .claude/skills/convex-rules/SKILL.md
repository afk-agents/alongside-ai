---
name: convex-rules
description: Understand and use Convex rules whenever touching the backend code, database, or query or mutation functions. Use when writing new functions, updating existing functions, or reading the database.
---
